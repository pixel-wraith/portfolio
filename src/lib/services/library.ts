...
const books = [
    ...
    bookSchema.parse({
        id: 'simple-marketing-for-smart-people',
        title: 'Simple Marketing for Smart People',
        url: 'https://www.amazon.com/Simple-Marketing-Smart-People-Customers/dp/B0D66H733H/ref=sr_1_1',
        image: 'https://images.wraithcode.io/2026-07/simple-marketing-for-smart-people-400.png',
        favorite: true,
        currentlyReading: false,
        read: true,
    }),

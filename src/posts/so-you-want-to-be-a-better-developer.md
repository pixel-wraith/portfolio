---
title: "So You Want To Be A Better Developer?"
description: "The software development journey is a strange one. There's no definitive starting point. There's no..."
date: "2023-10-28"
...
Fortunately, the solution is simple...just dive into something you aren't completely comfortable with! It could be a new kind of project you've never worked on, or learning a new technology you've never used before. You'll probably be uncomfortable at first, but that's good!
...
This is something I think good managers do well for their employees. They push them to do thing that are just a bit over their head or beyond their current skill level, forcing them to push themselves and to learn new things. This is what I mean here...only doing it for yourself.
...
I've seen people who learn ridiculously fast when they read a book, but they struggle when reading documentation alone. I've seen other people pick up 1 technology really fast, and then it took them a LONG time to learn another, using the same method. Some people learn by doing...but not when they build similar projects over and over again (like building a todo app when they learned Javascript, and then building another one when they learned Python). I've even known someone who struggled to learn new things when it was silent. They were able to focus more on what they were learning when they had background noise.

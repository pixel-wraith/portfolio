---
title: "My 8 Tips for a Better Life as a Developer"
description: "I've been a software developer and engineer for almost 13 years now and have learned a lot, both from..."
date: "2023-10-19"
...
I personally use the [Secretlab Titan Evo (Batman Themed)](https://secretlabchairs.ca/products/titan-evo-2022-series?sku=R22PU-Batman) and have been very happy with it for many years now. And compared to many of the high end desk chairs out there, the price tag isn't too bad.
...
My mouse is the [Logitech MX Master 3S](https://www.amazon.com/dp/B09HM94VDS?th=1&linkCode=sl1&tag=wraith02-20&linkId=0fddb57b864b8d7f85fea1e3702081c4&language=en_US&ref_=as_li_ss_tl). It's got a higher price point than many others, but it has a nice weight, feel, and responsiveness that I've enjoyed for quite a while now.
...
The thing I want to stress here is not finding tools that everyone uses because they can do all kinds of things. It's more about finding tools that you actually *enjoy* and *look forward* to using, that get the job done. Even if they can't do all the fancy things some other tools can do, if you actually look forward to using another tool, then use it! Having tools we actively enjoy really adds a lot of positivity into our lives.
...
- Raycast
  - This has replaced Spotlight for my on my Mac. And with the pro version (or using your own API keys), AI is just one quick keyboard shortcut away. Game changer for me!
- Obsidian
...
- BuzyBee
  - Kind of a shameless plug, but this is my own personal productivity app. I adopted the Getting Things Done system many years ago, but never found a digital tool I liked using with the system. So like any good engineer, I built my own. Fast forward several years, and I still use this daily to manage everything I wand and need to get done (plus I'm adding new stuff all the time to make me even more productive!)

What are some of the tools that bring you joy in your daily development life?
...
By doing this, I've found that I am remembering things much more thoroughly. And if I can't, I have a record of it and can pull it up with any context I want to remember along with it! It's allowed me to complete way more documentation for work, and I even have 4 or 5 blog posts in the works at any given time! Far fewer things are falling through the cracks, and I'm able to accomplish so much more.
...
## Conclusion
Over the last 13 years of working as a software developer and engineer, I've learned a lot. I've gone through good times and bad, and have picked up some really helpful life lessons along the way. By finding places I enjoy working at, investing a little more time and money into my hardware, finding tools I *like* using, settings goals, being curious and focussing on *why*, defining time for focussed work, focussing on keeping PRs small, and writing down everything I can, I can honestly say that my developer experience is greatly improved. 

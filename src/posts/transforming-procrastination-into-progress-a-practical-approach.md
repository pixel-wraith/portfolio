---
title: "Transforming Procrastination into Progress: A Practical Approach"
description: "This week, rather than discussing how to do more, I thought we'd focus on one of productivity's..."
date: "2025-03-31"
tags: ["productivity"]
...
I personally like to use David Allen's [Getting Things Done](https://gettingthingsdone.com/) method which breaks everything down into individual, physical actions. Anything that takes multiple physical actions is considered a project.  What exactly does that mean? Let’s consider an example. 
...
In his book [Eat That Frog](https://a.co/d/6mFsciG), Brian Tracy focusses on the idea that the things you have to do are like eating frogs...a not so enjoyable experience. His argument being that you already have to eat...so it's better to eat 1 big frog once, than it is to eat a bunch of small frogs.

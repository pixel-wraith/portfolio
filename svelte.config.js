...
const config = { kit: {
    ...
    csp: {
        ...
        directives: {
            ...
            'connect-src': ['self', 'https://cloud.umami.is', 'https://api-gateway.umami.dev', 'https://api-gateway-eu.umami.dev', 'https://ka-f.fontawesome.com', 'https://ka-p.fontawesome.com', 'https://*.ingest.us.sentry.io'],
